    ...
    <div>
      ...
      <div className="p-4 lg:p-6 space-y-6 max-w-2xl">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="rounded-xl border border-brand-border dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-card space-y-5">
          ...
          <Input label="Sidebar Logo URL" value={form.sidebarLogo} onChange={(e) => setForm({ ...form, sidebarLogo: e.target.value })} />
          <Input label="Header Logo URL" value={form.headerLogo} onChange={(e) => setForm({ ...form, headerLogo: e.target.value })} />
