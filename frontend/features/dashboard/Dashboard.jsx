    ...
    <div className="p-4 lg:p-6 space-y-6 bg-brand-background min-h-screen text-brand-text-primary transition-colors duration-200">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Link href="/catalog/courses?create=true">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {[
          ...
          <motion.div
            ...
            className="rounded-2xl border border-brand-border bg-brand-surface p-5 shadow-card hover:shadow-card-hover transition-all flex flex-col justify-between"
          >
            <div className="flex justify-between items-start">
              <span className="text-xs font-semibold text-brand-text-secondary uppercase tracking-wider">{item.label}</span>
            ...
            <div className="mt-3">
              ...
              <p className="text-[10px] text-brand-text-secondary mt-0.5 line-clamp-1">{item.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
