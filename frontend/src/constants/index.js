export const BRAND_DEFAULTS = {
  ...
  lightModeLogo: '/assets/Logo-Purple.png',
  darkModeLogo: '/assets/Logo-White.png',
  websiteLogo: '/assets/Logo-Purple.png',
  loginLogo: '/assets/Logo-Purple.png',
  mobileLogo: '/assets/Logo-Purple.png',
  footerLogo: '/assets/Logo-Purple.png',
};
